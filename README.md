...
* **Link para abrir las paginas (gh-pages):** [PAGINA PRINCIPAL](), [PAGINA DEL JUEGO](), [LOOSING PAGE]() y [WINNING PAGE]() (con el uso de javascript haremos la conexión entre las paginas mostradas, por por el momento como el codigo no esta desarrollado, linkeamos algunas paginas, a traves de las cuales se puede llegar a todas las otras)
